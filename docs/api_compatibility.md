...
| Ruler active/standby fencing                                   | Supported        | Each shard uses a durable coordination lease and Kafka producer epoch; WAL, `ALERTS`, and persisted ruler state commit transactionally before Alertmanager dispatch                                                          |
