...
impl<'a> Parser<'a> {
    ...
    pub(crate) fn parse(mut self) -> Result<StreamQuery, ParseError> {
    ...
    pub(crate) fn parse_metric(mut self) -> Result<MetricQuery, ParseError> {
        self.skip_ws();
    ...
    pub(crate) fn parse_metric_range_stream_query(
        &mut self,
    ...
    pub(crate) fn parse_metric_label_replace(mut self) -> Result<MetricLabelReplace, ParseError> {
        self.skip_ws();
    ...
    pub(crate) fn parse_metric_label_join(mut self) -> Result<MetricLabelJoin, ParseError> {
        self.skip_ws();
    ...
    pub(crate) fn parse_metric_function_argument(
        &mut self,
        function_name: &str,
    ...
    pub(crate) fn parse_metric_binary_set(mut self) -> Result<MetricBinarySet, ParseError> {
        self.skip_ws();
    ...
    pub(crate) fn parse_metric_vector_matching_modifier(
        &mut self,
    ...
    pub(crate) fn parse_metric_vector_group_modifier(
        &mut self,
    ...
    pub(crate) fn parse_optional_grouping_labels(&mut self) -> Result<Vec<String>, ParseError> {
        self.skip_ws();
        if self.peek() == Some('(') {
    ...
    pub(crate) fn parse_arithmetic_op(&mut self) -> Option<MetricScalarArithmeticOp> {
    ...
    pub(crate) fn parse_scalar_literal_text(&mut self) -> Result<String, ParseError> {
        self.skip_ws();
        let start = self.pos;
    ...
    pub(crate) fn try_parse_vector_aggregation_op(&mut self) -> Option<VectorAggregationOp> {
    ...
    pub(crate) fn parse_vector_aggregation_parameter(
        &mut self,
    ...
    pub(crate) fn parse_u64_scalar(&mut self) -> Result<u64, ParseError> {
        let start = self.pos;
        while self.peek().is_some_and(|ch| ch.is_ascii_digit()) {
            self.pos = self.pos.saturating_add(1);
        }
    ...
    pub(crate) fn parse_grouping_labels(&mut self) -> Result<Vec<String>, ParseError> {
        self.expect('(')?;
    ...
    pub(crate) fn parse_range_aggregation(&mut self) -> Result<RangeAggregationKind, ParseError> {
    ...
    pub(crate) fn parse_quantile(&mut self) -> Result<Quantile, ParseError> {
        self.skip_ws();
        let whole_start = self.pos;
        while self.peek().is_some_and(|ch| ch.is_ascii_digit()) {
            self.pos = self.pos.saturating_add(1);
    ...
    pub(crate) fn parse_stream_query(&mut self) -> Result<StreamQuery, ParseError> {
        self.skip_ws();
        self.expect('{')?;
        let matchers = self.parse_matchers()?;
        self.expect('}')?;
    ...
    pub(crate) fn parse_range_selector(&mut self) -> Result<DurationNanos, ParseError> {
        self.expect('[')?;
        self.skip_ws();
    ...
    pub(crate) fn parse_range_offset(&mut self) -> Result<OffsetNanos, ParseError> {
    ...
    pub(crate) fn parse_prometheus_duration(&mut self) -> Result<i64, ParseError> {
    ...
    pub(crate) fn parse_matchers(&mut self) -> Result<Vec<LabelMatcher>, ParseError> {
    ...
    pub(crate) fn parse_match_op(&mut self) -> Result<MatchOp, ParseError> {
        for (text, op) in [
            ("=~", MatchOp::RegexEqual),
    ...
    pub(crate) fn try_parse_line_filter(&mut self) -> Result<Option<LineFilter>, ParseError> {
    ...
    pub(crate) fn parse_label_format(&mut self) -> Result<LabelFormat, ParseError> {
    ...
    pub(crate) fn parse_json_parser_config(&mut self) -> Result<JsonParserConfig, ParseError> {
    ...
    pub(crate) fn parse_logfmt_parser_flags(&mut self) -> (bool, bool) {
    ...
    pub(crate) fn parse_logfmt_parser_config(
        &mut self,
        strict: bool,
        keep_empty: bool,
    ...
    pub(crate) fn parse_label_selection_set(&mut self) -> Result<LabelSelectionSet, ParseError> {
    ...
    pub(crate) fn parse_field_filter(&mut self) -> Result<FieldFilter, ParseError> {
        self.skip_ws();
        let name = self.parse_ident()?;
        self.skip_ws();
        let op = self.parse_comparison_op()?;
    ...
    pub(crate) fn parse_comparison_op(&mut self) -> Result<ComparisonOp, ParseError> {
        for (text, op) in [
    ...
    pub(crate) fn parse_field_value(&mut self) -> Result<FieldValue, ParseError> {
        if self.consume_keyword("ip") {
            self.expect('(')?;
            let pattern = self.parse_quoted()?;
            self.expect(')')?;
