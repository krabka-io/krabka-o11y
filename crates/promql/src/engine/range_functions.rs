...
# [cfg (feature = "experimental-functions")] use double_exponential_smoothing::double_exponential_smoothing;
# [cfg (feature = "experimental-functions")] use double_exponential_smoothing_sample_from_series::double_exponential_smoothing_sample_from_series;
...
# [cfg (feature = "experimental-functions")] pub (super) use validate_smoothing_factor::validate_smoothing_factor;
