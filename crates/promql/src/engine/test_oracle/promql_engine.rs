...
impl<S: MetricStore> PromqlEngine<S> {
    ...
    #[cfg(test)]
    pub(crate) fn eval_instant_expr<'a>(
        &'a self,
        tenant: &'a str,
        expr: &'a Expr,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_instant_selector_via_planner(
        &self,
        tenant: &str,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_instant_aggregate(
        &self,
        tenant: &str,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_k_aggregate(
        &self,
        tenant: &str,
        aggregate: &AggregateExpr,
        time_ms: i64,
    ...
    pub(crate) async fn eval_limitk_aggregate(
        &self,
        tenant: &str,
        aggregate: &AggregateExpr,
        time_ms: i64,
    ...
    #[cfg(all(test, feature = "experimental-functions"))]
    pub(crate) async fn eval_limit_ratio_aggregate(
        &self,
        tenant: &str,
        aggregate: &AggregateExpr,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_quantile_aggregate(
        &self,
        tenant: &str,
        aggregate: &AggregateExpr,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_count_values_aggregate(
        &self,
        tenant: &str,
        aggregate: &AggregateExpr,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_instant_binary(
        &self,
        tenant: &str,
        binary: &BinaryExpr,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_instant_unary(
        &self,
        tenant: &str,
        unary: &UnaryExpr,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_instant_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_clamp_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_sort_by_label_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_calendar_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_scalar_function_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_vector_function_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_histogram_quantile_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(all(test, feature = "experimental-functions"))]
    pub(crate) async fn eval_histogram_quantiles_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_histogram_fraction_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_label_join_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_label_replace_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_deriv_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_absent_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_absent_over_time_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_timestamp_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_quantile_over_time_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(test)]
    pub(crate) async fn eval_predict_linear_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
    ...
    #[cfg(all(test, feature = "experimental-functions"))]
    pub(crate) async fn eval_double_exponential_smoothing_call(
        &self,
        tenant: &str,
        call: &Call,
        time_ms: i64,
