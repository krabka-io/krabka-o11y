use super::{BinaryExpr, BinaryOp, InstantValue, PromqlError, QueryResult, Result, ScalarSide, SetOp, eval_vector_set_binary, eval_vector_vector_binary, validate_binary_modifier, validate_set_modifier};
