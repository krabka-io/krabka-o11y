use super::{
    Arc, ArrayRef, BTreeMap, FixedSizeBinaryBuilder, Int64Builder, NestedAttrColumn, RecordBatch,
    SpanMatcher, StringBuilder, TraceqlError, UInt32Array, append_nested_attr, append_nested_event,
