...
use krabka_logql::{
    ...
    LineFilterOp, LogfmtParserConfig, LogqlExpr, MatchOp, MetricBinarySetOp, MetricQuery,
...
use crate::{
    http::response::query_stats::populate_loki_query_execution_stats, metrics::ServiceMetrics,
};
    ...
    querier::{
        ...
        metric_eval::{
            ...
            expressions::{
                ...
                loki_range_vector_response, scalar_vector_expression_result,
        ...
        scan::{
            ...
            object_store_scans::{
                ColdBlockScan, execute_metric_query_range_from_object_store_with_hot_tail_frontier,
                execute_metric_query_range_from_object_store_with_hot_tail_frontier_and_deletes,
            },
            stream_scans::{
                QueryHotTail, StreamScanOptions, default_block_fetch_concurrency,
