use super::{
    ...
    StatusCode, execute_detected_fields_query, json_response, post_query_params_body_first,
};
...
pub(crate) async fn detected_fields_post(
    ...
    match execute_detected_fields_query(&state, &security, &headers, Some(&raw_query)).await {
