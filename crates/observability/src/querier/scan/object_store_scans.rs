use crate::{
    Arc, BTreeMap, LabelIndex, MetricQuery, MetricWindow, NonZeroUsize, ObjectPath, ObjectStore,
    QueryError, QueryHotTail, StreamPlan, TimeRange, Value, append_matching_hot_metric_record,
