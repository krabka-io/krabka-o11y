...
pub use compactor::{
    ...
    ObjectStoreCompactionIndexSink, SystemCompactionClock, TenantBatches, TenantCompactionRows,
    ...
    encode_tenant_batches, enforce_compaction_retention, poll_compactor_consumer_once,
