use super::{BlockWriter, CompactionIndexSink, CompactionOffsetCommitter, CompactionWalRecord, CompactionWindowError, CompactionWindowResult, write_compaction_partition_window};
