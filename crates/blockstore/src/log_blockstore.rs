...
mod delete_tenant_log_index_shard_from_object_store;
...
pub use delete_tenant_log_index_shard_from_object_store::delete_tenant_log_index_shard_from_object_store;
